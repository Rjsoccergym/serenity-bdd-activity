...
public class FormPage extends PageObject{
    ...
    public static Target SEX =
            Target.the("sex").locatedBy("//input[@id='checkbox-{0}']");
    ...
    public static Target DATE =
            Target.the("date").located(By.id("datepicker"));
    public static Target SUBMIT_BUTTON =
            Target.the("submit").locatedBy("//a[@role='button']");
    public static Target ALERT =
            Target.the("alert").locatedBy("//div[@role='alert']");
}